  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="5">
        ...
        <el-col :span="4">
          <el-input placeholder="根据名字查找" clearable @clear="getAdminList" v-model="queryInfo.name">
          </el-input>
        </el-col>
        <el-col :span="2">
          <el-button type="primary" icon="el-icon-search" @click="getAdminList">搜索</el-button>
        </el-col>

        <el-col :span="2" :offset="12">
          <el-button type="primary" @click="addDialogOpen">添加管理员</el-button>
        </el-col>
      ...
      >
        ...
        <el-table-column label="操作" width="180px" align='center'>
          <template slot-scope="scope">
            <!-- 修改按钮 -->
            <el-tooltip effect="dark" content="修改管理员" placement="top" :enterable="false">
              <el-button
                      type="primary"
                      icon="el-icon-edit"
                      size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      handleSizeChange(newSize) {
        ...
        this.getAdminList(); //重新调用获得用户列表方法
      },
      ...
      async resetPassword(id, name) {
        ...
        const {data: res} = await this.$http.put("admin/resetPassword",
            {
              id: id,
              password: "123456"
            });
      ...
      async validateStudent(username) {
        const {data: res} = await this.$http.get("/admin/byUsername/" + username);
        return res;
      },
